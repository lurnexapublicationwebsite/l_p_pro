...
export const AnimatedTestimonials = ({
  ...
  const hasSocials = !!(current?.linkedinUrl || current?.collegeUrl);
  const textContainerBase =
    `${hasSocials ? "mt-6" : "mt-1"} text-slate-700 leading-relaxed text-base md:text-lg font-light`;
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              {/* SOCIAL ICONS */}
              {(current.linkedinUrl || current.collegeUrl) && (
